...
func DefaultProfile() *Profile {
	...
	page := Page{
		...
		Widgets: []Widget{
			...
			button("b-lock", "LOCK", "power.lock", false,
				Placement{Col: 1, Row: 9, ColSpan: 5, RowSpan: 3}),
			button("b-sleep", "SLEEP", "power.sleep", false,
				Placement{Col: 7, Row: 9, ColSpan: 5, RowSpan: 3}),
			button("b-restart", "RESTART", "power.restart", true,
				Placement{Col: 13, Row: 9, ColSpan: 5, RowSpan: 3}),
			button("b-shutdown", "SHUTDOWN", "power.shutdown", true,
