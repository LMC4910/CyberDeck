...
| **Done** | 36 tickets / 87 pts (…147, 180, 181) — **EPIC-2 & EPIC-6 complete; M2 reached** |
...
| **Blocked** | 21 |
| **Ready now** | 24 (106, 107, 108, 109, 124, 126, 144, 145, 148, 149, 172, 173, 174, 175, 176, 182, 183, 184, 185, 186, 187, 200, 201, 210) |
| **Completion** | **44%** (87 / 199 pts) |
| **Critical-path progress** | 17 / 31 pts (121 ✓, 120 ✓, 122 ✓, 123 ✓, 180 ✓, 181 ✓) |
...
| EPIC-8 Client Runtime & Widgets | 10 | 24 | 2 | 6 | 25% |
...
| PROJ-182 | Widget: button + toggle | EPIC-8 | P0 | 2 | 181 | ⬜ Backlog | Claude | ✅ Ready | 0% |
| PROJ-183 | Widget: slider + label + image | EPIC-8 | P0 | 2 | 181 | ⬜ Backlog | Claude | ✅ Ready | 0% |
| PROJ-184 | Widget: circular + linear gauge | EPIC-8 | P0 | 3 | 181 | ⬜ Backlog | Claude | ✅ Ready | 0% |
...
| PROJ-187 | Gesture capture (all slots) + 2-tap confirm | EPIC-8 | P0 | 3 | 181 | ⬜ Backlog | Claude | ✅ Ready | 0% |
...
| PROJ-210 | Designer canvas (renders as target device) | EPIC-9 | P0 | 3 | 181,163 | ⬜ Backlog | Claude | ✅ Ready | 0% |
...
| **M3** | Live telemetry on a phone | 160, 150, 170, 171, 180, 181, 184, 130, 132 | 🟨 In progress (8/9 — 184 left) |
